...
export default function PropertyDetailScreen() {
    ...
    const property = {
        ...
        description: 'A beautiful 2LDK apartment located in the heart of Shibuya. Features modern amenities, floor-to-ceiling windows, and access to a rooftop garden.',
