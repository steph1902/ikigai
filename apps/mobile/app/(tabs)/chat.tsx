...
export default function ChatScreen() {
  ...
  const [history, setHistory] = useState([
    {
      role: "system",
      content: "Hello! I am your AI real estate assistant. How can I help you today?",
    },
  ]);
    ...
    >
      ...
      <ScrollView className="flex-1 px-4 py-4">
        {history.map((msg, idx) => {
          return (
            <View
              // biome-ignore lint/suspicious/noArrayIndexKey: Index used for simple history list
              key={idx}
